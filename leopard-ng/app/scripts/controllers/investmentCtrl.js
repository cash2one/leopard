define(['app', 'service'], function (app) {
    ...
    app.controller('investmentCtrl', ['$scope', 'filterConfigProduce'
        ...
        var filterConfig = {
            ...
            requestConf = configFactory(['getAccountInvestment']),
            paginationConf = {
                item: null,
                current: 0,
                total: null,
        ...
        var assignmentModalIns = function($scope, $modalInstance, invest, type
            ...
            var detailConf = configFactory(['getAccountInvestmentDetail']);
            detailConf.params = {};
            detailConf.params['investment_id'] = invest.id;
            requestProxy(detailConf)
            .success(function(data, status, headers){
                assignmentInfo.investment = data;
            });
