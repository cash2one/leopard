define(['app', 'service', 'config'], function (app) {
    ...
    app.controller('assigneeContractCtrl', ['messagePrompt', 'configFactory', 'requestProxy', 'financeTools', '$scope'
        ...
        //produce post config
        requestConf = configFactory(['getAssigneeContract'], {params: {investment_id: contractId}});
